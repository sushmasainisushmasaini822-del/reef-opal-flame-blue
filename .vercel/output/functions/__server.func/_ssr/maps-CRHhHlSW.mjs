...
//#region node_modules/.nitro/vite/services/ssr/assets/maps-CRHhHlSW.js
...
var MAPS = [
	{
		...
		identity: "Mixed city, bridges, and height. Most FFWS/EWC series still live and die here. Information and bridge timing matter more than raw aim.",
		drops: [
			{
				name: "Clock Tower",
				risk: "hot",
	...
	},
	{
		...
		identity: "Tighter compounds, more verticality, shorter time-to-contact. Fights chain. The team that lingers on boxes gets walked.",
		drops: [
			{
	...
	},
	{
		...
		identity: "Long lanes, little cover, vehicles actually matter. Maro/SVD and Chrono rotates are not optional — they are the map.",
		drops: [
			{
				name: "Town / Refinery",
				risk: "hot",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Bermuda · Purgatory · Kalahari"
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Same sport, different problems. Bermuda is bridges and height. Purgatory is chained third parties. Kalahari is sand and sightlines. The IGL changes the drop, not the 12-alive rule."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-10 space-y-8",
				children: MAPS.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "mt-8 font-display text-sm tracking-wide uppercase",
							children: "Drops"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-3 grid gap-3 sm:grid-cols-2",
							children: m.drops.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										variant: d.risk === "hot" ? "default" : "muted",
										children: RISK[d.risk]
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								...
								children: m.rotate.map((x) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
								...
								className: "mt-3 space-y-2",
								children: m.late.map((x) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
									className: "text-sm text-foreground",
									children: x
								}, x))
							})] })]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-6 rounded-lg bg-surface px-4 py-3 text-sm",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
